            ...
            {otpSent ? (
              ...
              <form onSubmit={handleLogin} className="w-full space-y-6">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-2xl bg-black/40 backdrop-blur-md border border-white/[0.15] hover:bg-white/[0.06] hover:border-white/[0.25] text-white font-bold text-[13px] tracking-tight transition-all active:scale-[0.98] flex items-center justify-center gap-3"
                >
