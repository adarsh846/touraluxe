...
export function Preloader() {
  ...
  return (
    ...
    >
      ...
      {/* Kinetic Overhead Jet Silhouette Flight Path — Nose Aligned Perfectly Straight Right */}
      <div
        ref={jetRef}
        className="absolute top-[28%] sm:top-[34%] z-20 flex items-center gap-2 pointer-events-none opacity-0 will-change-transform"
      >
