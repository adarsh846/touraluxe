...
export function HeroSequence() {
  ...
  return (
    ...
    >
      ...
      */}
      <div ref={pinRef} className="absolute top-0 left-0 w-full h-screen-stable overflow-hidden bg-black">
        {/* Hardware-Accelerated Canvas with Cinematic Color Grading */}
        <canvas 
          ref={canvasRef} 
          className="absolute inset-0 w-full h-full object-cover object-[65%_50%] md:object-center scale-[1.02] transform-gpu will-change-transform" 
          id="hero-canvas" 
          style={{
        ...
        <div className="scroll-indicator absolute bottom-[clamp(6rem,12vw,8rem)] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 pointer-events-none md:hidden">
          <span className="text-[10px] font-medium tracking-[0.25em] uppercase bg-gradient-to-r from-[#89f7fe] to-[#66a6ff] bg-clip-text text-transparent opacity-80">
            Scroll
          </span>
          <svg
            ...
            viewBox="0 0 16 16"
            fill="none"
            stroke="url(#tailored-grad-sequence)"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          >
            <defs>
              <linearGradient id="tailored-grad-sequence" x1="0%" y1="0%" x2="100%" y2="100%">
