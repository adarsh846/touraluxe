      ...
      */}
      <div ref={pinRef} className="absolute top-0 left-0 w-full h-screen-stable overflow-hidden bg-black">
        ...
        <div className="scroll-indicator absolute bottom-[clamp(6rem,12vw,8rem)] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 pointer-events-none md:hidden">
          <span className="text-[10px] font-medium tracking-[0.25em] uppercase bg-gradient-to-r from-[#a18cd1] to-[#fbc2eb] bg-clip-text text-transparent opacity-80">
            Scroll
          </span>
          <svg
            ...
            viewBox="0 0 16 16"
            fill="none"
            stroke="url(#curated-grad-sequence)"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          >
            <defs>
              <linearGradient id="curated-grad-sequence" x1="0%" y1="0%" x2="100%" y2="100%">
