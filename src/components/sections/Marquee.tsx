...
export function Marquee() {
  ...
  return (
    ...
    >
      {/* Row 1: Left */}
      <div ref={row1Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-50 select-none whitespace-nowrap gap-[4vw]">
        {[...Array(6)].map((_, i) => (
      ...
      {/* Row 2: Right */}
      <div ref={row2Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-45 select-none whitespace-nowrap ml-[-25%] gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
      ...
      {/* Row 3: Left */}
      <div ref={row3Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-40 select-none whitespace-nowrap gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
      ...
      {/* Row 4: Right */}
      <div ref={row4Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-40 select-none whitespace-nowrap ml-[-25%] gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
      ...
      {/* Row 5: Left */}
      <div ref={row5Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-35 select-none whitespace-nowrap gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
      ...
      {/* Row 6: Right */}
      <div ref={row6Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-30 select-none whitespace-nowrap ml-[-25%] gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
      ...
      {/* Row 7: Left */}
      <div ref={row7Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-25 select-none whitespace-nowrap gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
      ...
      {/* Row 8: Right */}
      <div ref={row8Ref} className="will-change-transform flex items-center text-[clamp(1.2rem,8vw,10rem)] sm:text-[clamp(1.5rem,6vw,10rem)] font-bold uppercase leading-none -tracking-[0.02em] opacity-25 select-none whitespace-nowrap ml-[-25%] gap-[4vw]">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-[4vw]">
            <span className="text-outline-white">Beyond</span><span>Unseen</span><span className="text-outline-white">Boundless</span><span>Transcendent</span><span className="text-outline-white">Sovereign</span><span>Elite</span><span className="text-outline-white">Luxury</span><span>Excellence</span><span className="text-outline-white">Heritage</span><span>Sanctuary</span>
          </div>
      ...
      <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden md:hidden">
        ...
        {/* Row 1 */}
        <div className="marquee-chip will-change-transform absolute top-[18%] left-[4%] pointer-events-auto rotate-[11deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[20%] right-[4%] pointer-events-auto rotate-[-14deg]">
          <Magnetic>
        ...
        {/* Row 2 */}
        <div className="marquee-chip will-change-transform absolute top-[46%] left-[4%] pointer-events-auto rotate-[-8deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[48%] right-[4%] pointer-events-auto rotate-[18deg]">
          <Magnetic>
        ...
        {/* Row 3 */}
        <div className="marquee-chip will-change-transform absolute top-[74%] left-[4%] pointer-events-auto rotate-[-21deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[76%] right-[4%] pointer-events-auto rotate-[7deg]">
          <Magnetic>
      ...
      <div className="absolute inset-0 pointer-events-none z-10 overflow-hidden hidden md:block">
        ...
        {/* ── ROW 1 (top: 8–14%) ── */}
        <div className="marquee-chip will-change-transform absolute top-[8%] left-[5%] pointer-events-auto rotate-[-15deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[10%] left-[44%] pointer-events-auto rotate-[24deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[8%] right-[6%] pointer-events-auto rotate-[-28deg]">
          <Magnetic>
        ...
        {/* ── ROW 2 (top: 30–38%) ── */}
        <div className="marquee-chip will-change-transform absolute top-[30%] left-[18%] pointer-events-auto rotate-[13deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[34%] left-[56%] pointer-events-auto rotate-[-7deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[32%] right-[5%] pointer-events-auto rotate-[32deg]">
          <Magnetic>
        ...
        {/* ── ROW 3 (top: 56–64%) ── */}
        <div className="marquee-chip will-change-transform absolute top-[56%] left-[5%] pointer-events-auto rotate-[-20deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[58%] left-[44%] pointer-events-auto rotate-[8deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[60%] right-[6%] pointer-events-auto rotate-[-12deg]">
          <Magnetic>
        ...
        {/* ── ROW 4 (top: 82–88%) ── */}
        <div className="marquee-chip will-change-transform absolute top-[82%] left-[14%] pointer-events-auto rotate-[19deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[84%] left-[46%] pointer-events-auto rotate-[25deg]">
          <Magnetic>
        ...
        <div className="marquee-chip will-change-transform absolute top-[82%] right-[6%] pointer-events-auto rotate-[-26deg]">
          <Magnetic>
