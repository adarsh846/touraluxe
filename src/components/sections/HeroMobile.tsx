  ...
  return (
    ...
    >
      ...
      <div className="scroll-indicator absolute bottom-[clamp(6rem,12vw,8rem)] left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 opacity-0 pointer-events-none">
        ...
        <svg className="scroll-chevron w-4 h-4" viewBox="0 0 16 16" fill="none" stroke="url(#tailored-grad-mobile)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          <defs>
            <linearGradient id="tailored-grad-mobile" x1="0%" y1="0%" x2="100%" y2="100%">
