            ...
            >
              <Magnetic>
                <button
                  ...
                  className="rounded-full bg-white/5 border border-white/10 px-[clamp(1.75rem,4vw,3rem)] py-[clamp(0.875rem,2vw,1.5rem)] text-[clamp(11px,1.5vw,16px)] font-bold uppercase tracking-wider text-white transition-transform hover:scale-105 flex items-center justify-center gap-2"
                >
                  {user ? (
                    <>
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
