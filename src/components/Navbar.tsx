...
export function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col h-full pt-[clamp(5rem,10vw,8rem)] pb-32 md:pb-36 px-[clamp(2rem,6vw,6rem)] overflow-y-auto scrollbar-hide">
          <nav className="flex flex-col gap-[clamp(1.5rem,4vw,3rem)]">
            ...
            <div
              className={cn(
                "mt-[clamp(2rem,4vw,4rem)] pt-[clamp(1.5rem,3vw,3rem)] border-t border-white/10 transition-all duration-500 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 max-w-2xl",
            ...
            >
              <Magnetic className="flex-1">
                <button
                  ...
                  className="w-full rounded-full bg-white px-6 py-3.5 sm:py-4 text-xs sm:text-sm font-black uppercase tracking-widest text-black transition-transform hover:scale-105 text-center shadow-xl"
                >
                  Track Your Booking
                </button>
              </Magnetic>
              ...
              {whatsappNumber && (
                <Magnetic className="flex-1">
                  <a
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="w-full rounded-full bg-[#121214]/90 border border-white/10 backdrop-blur-2xl px-6 py-3.5 sm:py-4 text-xs sm:text-sm font-black uppercase tracking-widest text-white transition-all duration-500 hover:border-[#25D366]/40 active:scale-[0.98] text-center flex items-center justify-center gap-2.5 shadow-[0_8px_30px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.08),0_0_15px_rgba(37,211,102,0.03)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.12),0_0_25px_rgba(37,211,102,0.12)] group"
                  >
                    <svg 
                      className="w-4 h-4 sm:w-5 sm:h-5 text-[#25D366] transition-transform duration-500 group-hover:scale-110 shrink-0" 
                      viewBox="0 0 448 512" 
                      fill="currentColor" 
